...
def get_car_information(car_model,car_company,car_description,car_range,car_seats,car_price,car_image_url):
    ...
    keys = ['BMW i3', 'Chevrolet Bolt EV', 'Fiat 500e', 'Ford Focus Electric', 'Honda Clarity Electric', 
            'Hyundai Ioniq Electric', 'Kia Soul EV', 'Mercedes B250e', 'Nissan LEAF', 'Quantya Strada', 'Smart ED',
            'Tesla Model 3', 'Tesla Model S', 'Tesla Model X', 'Victory Empulse TT', 'Volkswagen e-Golf', 
            'Zero Motorcycles Zero DS/DSR', 'Zero Motorcycles Zero FX/FXS', 'Zero Motorcycles Zero S/SR']
    for i in range(len(car_company)):
        ...
        temp[keys[i]] = cars_information_appender
    return temp
